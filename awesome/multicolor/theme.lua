...
theme.wallpaper                                 = theme.confdir .. "/futuristic.jpg"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({position = "top", expand ="outside", screen = s, height = dpi(25),border_width=2 ,bg = "#0e1419", fg = theme.fg_normal })
